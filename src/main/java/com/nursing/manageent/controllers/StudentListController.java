...
public class StudentListController {
    ...
    @FXML private Lable lblCategory;
 ...
 *******************************************************************************************************
    ...
    * */
    ...
    private void handleDelete(){
        Student selsctedStudent = studentTable.getSelectionModel().getSelectedItem();
        if(selectedStudent != null){
            ...
            if(alert.showAndWait().get()== ButtonType.OK){
                new StudentDAO().deleteStudent(selectedStudent.getStudenId());
                loadStudents();
            }
        }
    }
